    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="./addbloodinfo.php">Add Blood info</a></li>
...
<div class="panel panel-success panel-size-custom">
          ...
          <div class="col-lg-6">
            <form action="./addbloodinfo2.php" method="POST">
              <div class="form-row">
                <div class="col form-group">
                  <input type="text" name="bloodtype" class="form-control" id="bloodtype" placeholder="Blood Type" data-rule="minlen:2" data-msg="Please enter at least 2 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col form-group">
                  <input type="text" name="hospitalname" class="form-control" id="hospitalname" placeholder="Hospital Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <div class="validate"></div>
                </div>
              </div>
