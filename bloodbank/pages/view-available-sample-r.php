...
{
  header('Location: ../index.html'); //redirection to index.html if session doesn't exist
}
?> 
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <?php
  			echo $_SESSION['email']; //user email after login
      ?>

      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="./rhome.php">Home</a></li>
          <li><a href="./request-available-sample.php">Request Sample</a></li>
          <li><a href="./logout.php">Logout</a></li>

        </ul>
      </nav><!-- .nav-menu -->

    <a href="./view-available-sample.php" disabled=true class="appointment-btn scrollto" href="javascript:void(0)" onclick="scrollToDownload()"><span class="d-none d-md-inline">Available Blood Sample</span></a>
</div>
  </header><!-- End Header -->
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td>".$res['hospital_name']."</td><th></th>";  
                                        }}?>
                                </table><br><br><br><br>
                        </div>
                    </div> 
