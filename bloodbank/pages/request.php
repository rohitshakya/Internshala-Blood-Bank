...
{
  header('Location: ../index.html'); //if session doesn't exist then redirect to index.html
}
?> 
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li  class="active"><a href="./request.php">View Request</a></li>
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) { 
                                              echo "<tr>";
                                                ...
                                                echo "<td>".$res['request_name']."</td>";
                                                echo "<td>".$res['request_hospital_name']."</td>";
                                              echo "<td>".$res['request_blood_type']."</td>";}}?>
                              </table><br><br><br><br>
                        </div>
                    </div> 
                </div>
